    ...
    <div class="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
  	...
  	>
  		  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z" />
		  </svg>
  		</button>
    </div>
  </div>
    ...
    <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
	  ...
	  <div class="p-2 sm:w-1/2 w-full">
		<div class="bg-gray-100 rounded flex p-4 h-full items-center">
		  <svg fill="currentColor" stroke="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="text-yellow-500 w-6 h-6 flex-shrink-0 mr-4" viewBox="0 0 24 24">
