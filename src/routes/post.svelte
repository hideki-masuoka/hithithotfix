<script>
	...
	const LabelAddSolution = 'このようにします';

	const SolutionA = '「プリントスクリーン」を検索';
	const SolutionB = '画像ファイルを保存する方法が分かるように';
</script>
...
<section class="text-gray-600 body-font">
  ...
  <div class="text-right w-full lg:w-4/5 pb-16">
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-8 mx-auto flex items-center justify-center md:flex-row flex-col lg:w-4/5">
